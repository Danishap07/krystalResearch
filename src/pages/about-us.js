  ...
  return (
    ...
    <div>
      ...
      <div className='bg-white pb-10'>
        <h3 className='font-bold text-center text-2xl pt-6 text-black'>WHY KRS?</h3>
        <div className='bg-[#abf0f0] mx-6 rounded-full md:mx-32'>
      ...
      <div className='py-6 bg-gradient-to-r from-[#D6F6F6] to-slate-50 text-center'>
        <h3 className='font-bold text-center text-2xl pt-2 uppercase text-black'>How can we help you?</h3>
