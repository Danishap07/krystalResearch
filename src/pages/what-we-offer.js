    ...
    return (
        <>
            ...
            <div>
                ...
                <div  className=''>
                    <section ref={el => sectionsRef.current[0] = el} className='py-10 text-center'>
                        <div className='md:mx-[25%] mx-4 font-bold'>
                    ...
                    <section ref={el => sectionsRef.current[1] = el} className='md:mx-32 '>
                        <h3 className='text-4xl font-semibold text-center md:text-left text-[#002147]'>Qualitative</h3>
                        <div className="md:flex justify-between">
                            <div className='md:mx-4 flex justify-center mt-4'>
                                <ImageComponent src='/assets/doc1.png' alt='home doc' />
                            </div>
                            <div className='md:w-[100%] mx-4 md:ml-20'>

                                <p className='my-6 bg-gradient-to-r from-[#D6F6F6] to-slate-50  font-semibold p-2 pl-2 rounded-full text-black'>IDIs</p>
                                <p className='my-6 bg-gradient-to-r from-[#D6F6F6] to-slate-50  font-semibold p-2 pl-2 rounded-full text-black'>TDIs</p>
                                <p className='my-6 bg-gradient-to-r from-[#D6F6F6] to-slate-50  font-semibold p-2 pl-2 rounded-full text-black'>Moderation</p>
                                <p className='my-6 bg-gradient-to-r from-[#D6F6F6] to-slate-50  font-semibold p-2 pl-2 rounded-full text-black'>KOLs</p>
                            </div>
                        </div>
                    </section>
                    ...
                    <section ref={el => sectionsRef.current[2] = el} className='md:mx-32'>
                        ...
                        <div className="md:flex justify-between">
                            ...
                            <div className='md:w-[100%] mx-4 md:ml-12 '>
                                ...
                                <p className='my-6 bg-gradient-to-r from-[#D6F6F6] to-slate-50 font-semibold p-2 pl-2 rounded-full text-black'>Online top-ups and full service projects</p>
                                <p className='my-6 bg-gradient-to-r from-[#D6F6F6] to-slate-50 font-semibold p-2 pl-2 rounded-full text-black'>Trackers</p>
                                <p className='my-6 bg-gradient-to-r from-[#D6F6F6] to-slate-50 font-semibold p-2 pl-2 rounded-full text-black'>PRFs</p>
                ...
                <section ref={el => sectionsRef.current[6] = el} className='bg-gradient-to-r from-[#D6F6F6] to-slate-50 '>
                    ...
                    <div className='flex align-middle  md:mx-40 pb-8 py-6'>
