...
function Footer() {
  return (
    <div className='bg-[#5E5E5E] text-center md:text-left  md:px-40 md:pt-10'>
      
      <div className='md:flex justify-between '>
        <div className=''>
        <h3 className='text-3xl font-light text-neutral-200 mb-5 uppercase md:text-left' style={rubik.style}><span className='font-medium'>Krystal</span>Research</h3>
